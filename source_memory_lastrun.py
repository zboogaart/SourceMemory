...
expName = 'source_memory'  # from the Builder filename that created this script
expInfo = {'participant': '', 'time': '', 'group': ''}
...
filename = _thisDir + os.sep + 'data/%s_%s_%s_%s' %(expInfo['participant'], expInfo['time'], expName, expInfo['date'])

# An ExperimentHandler isn't essential but helps with data saving
thisExp = data.ExperimentHandler(name=expName, version='',
    extraInfo=expInfo, runtimeInfo=None,
    originPath='C:\\Users\\zboogaart\\Desktop\\SourceMemory\\SourceMemory\\source_memory_lastrun.py',
...
for thisRetrieval_trials1 in retrieval_trials1:
    ...
    image_4.setImage('stimulus_images_' + expInfo['time'] + '/' + stimImg)
    item_rec_resp.keys = []
    item_rec_resp.rt = []
