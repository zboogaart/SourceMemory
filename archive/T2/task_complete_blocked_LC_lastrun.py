...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\lacherep\\Desktop\\Source Memory Task T1 & T2\\T2\\task_complete_blocked_LC_lastrun.py',
...
while continueRoutine:
    ...
    if scanner_pulse.status == STARTED and not waitOnFlip:
        theseKeys = scanner_pulse.getKeys(keyList=['5'], waitRelease=False)
